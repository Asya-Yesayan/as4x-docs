...
### EventArgsDocConfigureDCRFields Class

Պարունակում է տվյալներ փաստաթղթի [ConfigureDCRFields](ConfigureDCRFields.md) իրադարձության մշակիչին փոխանցելու համար։

|Հատկություն|Նկարագրություն|
|:--|:--|
| `Doc` | Իրադարձությունը առաջացնող փաստաթուղթը։ |
| `FieldInclusions` | Dictionary, որտեղ բանալին փաստաթղթի դաշտի անունն է, իսկ արժեքը` DCR-ի փոփոխությունների տեքստային հաշվետվությունում դաշտի ցուցադրման հայտանիշը (true  - ներառել, false - չներառել): |
