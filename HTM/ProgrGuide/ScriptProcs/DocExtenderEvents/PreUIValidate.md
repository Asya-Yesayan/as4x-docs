...
PreUIValidate իրադարձությունը առաջանում է փաստաթուղթը ինտերֆեյսից գրանցելիս` [UIValidate](../UIValidate.md) իրադարձությունից առաջ (նախքան [գրանցման տրանզակցիայի](../../Functions/ASDOC/Store.md) բացվելը)։
