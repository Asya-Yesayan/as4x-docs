...
Այս իրադարձությունը թույլ է տալիս որոշել, թե փաստաթղթի որ դաշտերի փոփոխությունները պետք է ցուցադրվեն [տեքստային հաշվետվությունում](../Functions/AsRepViewer.md), որը բացվում է **«Փաստաթղթի պատմություն»** դիտելու ձևի **«Դիտել փոփոխությունները տեքստային»** կոնտեքստային ֆունկցիայով։

Լռությամբ նշված [տեքստային հաշվետվությունում](../Functions/AsRepViewer.md) ցուցադրվում են այն դաշտերը, որոնք չունեն **H** ատրիբուտը։
