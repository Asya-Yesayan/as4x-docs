...
| [CreationLogMsg](CreationLogMsg.md) | Վերադարձնում կամ նշանակում է փաստաթղթի փոփոխման հայտի ստեղծման ժամանակ [փաստաթղթի պատմությունում](../../Database/DocLog.md) գրանցվող հաղորդագրությունը։ |
